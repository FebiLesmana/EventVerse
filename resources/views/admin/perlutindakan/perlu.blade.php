...
<body class="bg-white">
  ...
  <div class="min-h-screen flex flex-col">
    ...
    <div class="flex flex-1">
      @include('components.nav-admin-perlutindakan')
          ...
          <table class="w-full border border-gray-300 rounded-lg">
            <thead>
              <tr class="bg-white border-b border-gray-300">
                ...
                <th class="text-left text-gray-600 font-semibold text-sm py-3 px-5 border-r border-gray-300 items-center justify-center">Accept / Decline</th>
                <th class="text-left text-gray-600 font-semibold text-sm py-3 px-5 border-r border-gray-300 items-center justify-center">Publish</th>
              </tr>
            </thead>
            <tbody>
