...
<body class="bg-white">
  ...
  <div class="min-h-screen flex flex-col">
    ...
    <div class="flex flex-1">
      @include('components.nav-admin-permohonan')
          ...
          <table class="w-full border border-gray-300 rounded-lg">
            <thead>
              <tr class="bg-white border-b border-gray-300">
                <th class="text-left text-gray-600 font-semibold text-sm py-3 px-5 border-r border-gray-300">Nama Event</th>
                <th class="text-left text-gray-600 font-semibold text-sm py-3 px-5 border-r border-gray-300">Jenis Event</th>
                <th class="text-left text-gray-600 font-semibold text-sm py-3 px-5 border-r border-gray-300">Deskripsi</th>
                <th class="text-left text-gray-600 font-semibold text-sm py-3 px-5 border-r border-gray-300">Tempat Pelaksanaan</th>
                <th class="text-left text-gray-600 font-semibold text-sm py-3 px-5 border-r border-gray-300">Waktu Pelaksanaan</th>
                <th class="text-left text-gray-600 font-semibold text-sm py-3 px-5 border-r border-gray-300">Pembicara</th>
                <th class="text-left text-gray-600 font-semibold text-sm py-3 px-5 border-r border-gray-300">Instagram</th>
                <th class="text-left text-gray-600 font-semibold text-sm py-3 px-5 border-r border-gray-300">Poster</th>
                <th class="text-left text-gray-600 font-semibold text-sm py-3 px-5 border-r border-gray-300">Cheking</th>
              </tr>
            </thead>
            <tbody>
              <tr class="border-b border-gray-300 text-gray-700 text-sm">
                ...
                <td class="py-4 px-5 border-r border-gray-300">Prof. Junaedi. S.pd., M.pd</td>
                <td class="py-4 px-5 border-r border-gray-300">Electrical Science Club</td>
                <td class="py-4 px-5 border-r border-gray-300">Electrical Science Club</td>
              ...
              <tr class="text-gray-700 text-sm">
                ...
                <td class="py-4 px-5 border-r border-gray-300">Dr. Anan Nugroho. S.T., M.Eng.</td>
                <td class="py-4 px-5 border-r border-gray-300">Electrical Science Club</td>
                <td class="py-4 px-5 border-r border-gray-300">Electrical Science Club</td>
                <td class="py-4 px-4 border-r border-gray-300">
                  <div class="flex items-center justify-center">
