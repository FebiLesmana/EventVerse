...
@section('main-content')
  <div class="pt-16 px-6 max-w-md mx-auto">
    ...
    <!-- Sign In Button -->
    <button class="w-full bg-yellow-400 rounded-xl py-3 text-white font-semibold text-lg mb-6 hover:bg-yellow-500 transition">Sign In</button>

  <!-- Bottom Text -->
  <div class="text-center mb-10 px-6">
    <p class="text-gray-400 text-sm">
      Don’t Have a account?
      <a href="#" class="text-yellow-400 font-semibold hover:underline">Sign Up</a>
    </p>
  </div>
@endsection
